...
The recurring failure pattern was not that agents could not write code. It was that a new session would confidently repeat a rejected approach because the rejection lived only in a chat transcript.
