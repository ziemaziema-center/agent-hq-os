...
Best for projects where context loss, repeated failures, and unvalidated AI edits are already slowing delivery.

Expected safe output: A booted AI session should produce a scope summary, risk scan, validation plan, completed work, and telemetry update.
